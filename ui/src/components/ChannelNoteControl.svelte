...
<button
  type="button"
  class="mp-control-gradient flex h-8 w-11 shrink-0 items-center justify-center whitespace-nowrap rounded-md border border-border-subtle px-2 py-2 text-[13px] leading-none text-text outline-none transition-[border-color,box-shadow,filter] duration-75 hover:border-border hover:brightness-105 focus-visible:ring-1 focus-visible:ring-focus-ring"
